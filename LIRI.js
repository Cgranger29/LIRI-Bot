...
var defaultMovie = "Wedding Crashers";
var defaultSong = "Crash into Me";



var twitterKeys = keys.twitter;
var tmdbKey = keys.spotify;
...
function getMyTweets(){
	...
	var params = {screen_name: 'jimmyfallon', count: 20, exclude_replies:true, trim_user:true};
...
function movieThis(movieName){
	let options = {  
		url: "https://api.themoviedb.org/3/search/movie?api_key=" + tmdbKey + "&query=" + movieName,
		proxy: 'http://proxy.bloomberg.com:81',
		ca: fs.readFileSync("F:\\BBrootNEW.cer")
	};
